<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-post-next">[scf-post-next]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs the link to the next post.', 'shortcode-factory')?></p>
