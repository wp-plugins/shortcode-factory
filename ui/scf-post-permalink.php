<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-post-permalink">[scf-post-permalink]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs permalink of the post. If ID or Slug is provided, outputs the permalink of that particular post.', 'shortcode-factory')?></p>
