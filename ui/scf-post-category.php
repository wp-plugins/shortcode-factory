<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-post-category">[scf-post-category]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs categories of the post. If ID or Slug is provided, outputs the categories of that particular post.', 'shortcode-factory')?></p>
